                        ...
                        <div class="nk-split-content nk-block-area nk-block-area-column nk-auth-container bg-white w-lg-45">
                            ...
                            <div class="nk-block nk-block-middle nk-auth-body">
                                ...
                                @enderror
                                    ...
                                    <div class="form-group">
                                        <label class="form-label" for="password">Conform Passcode</label>
                                        <div class="form-control-wrap">
                                            <a tabindex="-1" href="#" class="form-icon form-icon-right passcode-switch lg" data-target="password">
                                                <em class="passcode-icon icon-show icon ni ni-eye"></em>
                                                <em class="passcode-icon icon-hide icon ni ni-eye-off"></em>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="form-control-wrap">
                                          ...
                                          <select class="form-control valid" name="role" aria-invalid="false">
                                    ...
                                    <div class="form-group">
                                        <div class="custom-control custom-control-xs custom-checkbox">
                                            ...
                                            <label class="custom-control-label" for="checkbox">I agree to Terms and Condictions <a tabindex="-1" href="#">Privacy Policy</a> &amp; <a tabindex="-1" href="#"> Terms.</a></label>
                                        </div>
                                    </div>
                                    <div class="form-group">
