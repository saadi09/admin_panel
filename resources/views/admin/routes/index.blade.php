            	...
            	<div class="nk-block-head nk-block-head-sm">
                    <div class="nk-block-between">
                        <div class="nk-block-head-content">
                            <h3 class="nk-block-title page-title">Menu Routes</h3>
				        	...
				        	<table class="datatable-init table">
							    ...
							    <tbody >
									...
									<tr>
									    ...
									    <td>{{ $row->slug }}</td>
									    <td>
									    	<button class="btn btn-xs btn-warning" onclick="editItem({{ $row->id }});"><em class="icon ni ni-edit"></em> Eidt</button>
            ...
            <div class="modal-body">
                ...
                <div class="form-group">
                    ...
                    <div class="form-control-wrap">
                        <input type="text" class="form-control" name="route_name" id="role_name" required="">
                    </div>
                </div>
                <div class="form-group">
                    <label class="form-label" for="full-name">Role Slug <span class="text-danger">*</span></label>
                    <div class="form-control-wrap">
                        <input type="text" class="form-control" name="route_slug" id="role_slug" required="">
                    </div>
                </div>
